...
export default {
    ...
    getContentByContentLink: (contentLink, parameters) =>
        get(`${applicationPath}api/episerver/v2.0/`, `content/${contentLink}`, parameters, {'Accept-Language': '' }),

    getChildrenByContentLink: (contentLink, parameters, headers) =>
        get(`${applicationPath}api/episerver/v2.0/`, `content/${contentLink}/children`, parameters, headers),
    ...
    getInventory: (parameters) =>
        get(`${applicationPath}api/episerver/v2.0/`, 'inventory', parameters, {'Accept-Language': '' }),

    getWarehouse: (warehouseCode) =>
        get(`${applicationPath}api/episerver/v2.0/`, `warehouse/${warehouseCode}`, {}, { 'Accept-Language': '' }),

    getPricing: (parameters) =>
        get(`${applicationPath}api/episerver/v2.0/`, 'pricing', parameters, {'Accept-Language': '' })
};
