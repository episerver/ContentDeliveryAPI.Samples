...
import ProductPage from '@/Scripts/components/pages/ProductPage.vue';
import CategoryPage from '@/Scripts/components/pages/CategoryPage.vue';
// Views
...
Vue.component('FestivalProduct', ProductPage);
Vue.component('CategoryNode', CategoryPage);
